function Terms() {
    return (
        <div className="terms">
            ...
            <h2>Regulamin korzystania z Serwisu Still Fresh</h2><br/>

            <h2>§1 Definicje</h2><br />
            <strong>Serwis</strong> - strona internetowa prowadzona przez Still Fresh sp. z o.o.<br />
            <strong>Klient</strong> - osoba fizyczna lub osoba prawna korzystająca z Serwisu<br />
            <strong>Kupujący</strong> - osoba fizyczna lub osoba prawna, która dokonuje zakupu towaru<br />
            <strong>Sprzedawca </strong>- osoba fizyczna lub osoba prawna, która dokonuje sprzedaży towaru<br />

            <h2>§2 Postanowienia ogólne</h2><br />
            1.  Serwis internetowy działający pod nazwa Still Fresh jest pośrednikiem między Kupującym a Sprzedawcą.<br />
            2. Regulamin przedstawia warunki i zasady korzystania z Serwisu.<br />
            3. Regulamin skierowany jest do wszystkich Klientów Sklepu. Wszyscy Klienci są zobowiązani zapoznać się z regulaminem, a jego nieznajomość nie zwalnia z jego przestrzegania.<br />
            4. „Still Fresh” sp. z o.o. jest zobowiązana do sprawdzania Sprzedawców korzystających z Serwisu.<br />
            5. Płatności na stronie są przeprowadzane przez pośrednika płatności Przelewy24<br /><br />
            <h2>§3 Korzystanie z Serwisu przez Kupującego</h2><br />
            1. Zamówienia mogą być składane tylko przy użyciu prawdziwych danych klienta<br />
            2. Warunkiem korzystania z Serwisu jest zapoznanie się z regulaminem i jego akceptacja. Aby złożyć zamówienie Kupujący zobowiązany jest zaakceptować regulamin.<br />
            3. Zamówienie towaru następuje w skutek kliknięcia przycisku “dodaj do koszyka” na stronie towaru interesującego Klienta, a następnie przejście do zakładki “koszyk” w celu wypełnienia formularza zamówienia, wyboru formy dostawy i wyboru opcji zapłaty, a następnie potwierdzenia zakupu.
            4. Kupujący jest zobowiązany do odbioru zamówienia w przeciągu 48 godzin od zakupu towaru, w przypadku nieodebrania towaru zamówienie Kupującego jest anulowane bez zwrotu pieniędzy wydanych na ten towar.<br />
            <h2>§4 Korzystanie z Serwisu przez Sprzedawce</h2><br />
            1. Aby sprzedawca mógł zamieścić produkty na stronie, musi on wcześniej zostać zaakceptowany przez „Still Fresh” sp. z o.o. jako „zaufany sprzedawca”.<br />
            2. Warunkiem korzystania z Serwisu jest zapoznanie się z regulaminem i jego akceptacja. Aby zamieszczać oferty sprzedaży Sprzedawca zobowiązany jest zaakceptować regulamin.<br />
            3. Sprzedawca zobowiązuje się, że produkty zamieszczane przez niego na stronie są zdatne do spożycia i ich termin ważności w momencie znajdowania się na stronie wynosi minimum 48 godzin.<br />
            <h2>§5 Postanowienia końcowe</h2><br />
            1. Zaakceptowanie regulaminu i polityki prywatności serwisu jest wymagane do złożenia zamówienia i zaoferowania towaru<br />
            2. Sprzedawca stosuje się do kodeksu dobrych praktyk – zbioru zasad postępowania, a w szczególności norm etycznych i zawodowych, o których mowa w art 2 pkt. 5 Ustawy o przeciwdziałaniu nieuczciwym praktykom rynkowym z dnia 23 sierpnia 2007 roku z późniejszymi zmianami.<br />
            3. W sprawach nieuregulowanych niniejszym regulaminem stosuje się odpowiednio przepisy Kodeksu Cywilnego lub przepisów innych aktów prawnych mających zastosowanie do działalności i funkcjonowania Serwisu.<br />
            4. Sądem właściwym dla rozstrzygania sporów jest sąd miejscowo właściwy według obowiązujących przepisów.<br />
            5. Sprzedawca zastrzega sobie prawo do dokonywania zmian regulaminu w każdym czasie.<br />
            6. Wszelkie zamieszczone w Serwisie znaki towarowe i nazwy firmowe należą do prawnych właścicieli i  zostały umieszczone w celach informacyjnych.<br />
            ...
            <article>
                ...
                <p>Poniższa Polityka Prywatności jest integralną częścią <a href="www.stillfresh/regulamin">Regulaminu Serwisu</a>, który określa zasady, prawa i obowiązki Użytkowników korzystających z Serwisu.</p>
                <h2 >§1 Definicje</h2>
                <ul>
                    <li>
                        <p><strong>Serwis</strong> - serwis internetowy "Still Fresh" działający pod adresem www.stillfresh.pl</p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p><strong>Administrator Serwisu / Danych</strong> - Administratorem Serwisu oraz Administratorem Danych (dalej Administrator) jest firma "Still Fresh", prowadząca działalność pod adresem: Al. KEN 36 / 112B, WARSZAWA, o nadanym numerze identyfikacji podatkowej (NIP): 9482256434, świadcząca usługi drogą elektroniczną za pośrednictwem Serwisu</p>
                    </li>
                    <li>
                ...
                <ul>
                    ...
                    <li>
                        <p><strong>Cookies sesyjne</strong> - pliki zamieszczane i odczytywane z Urządzenia Użytkownika przez Serwis <span id="sz1" >lub Serwisy zewnętrzne</span> podczas jednej sesji danego Urządzenia. Po zakończeniu sesji pliki są usuwane z Urządzenia Użytkownika.</p>
                    </li>
                    <li>
                ...
                <ul id="zewnetrzne">
                    ...
                    <li>
                        <strong>Usługi społecznościowe / łączone:</strong>(Rejestracja, Logowanie, udostępnianie treści, komunikacja, itp.)<br />
                        <ul>
            ...
            <ul>
                <li>
                    <p><strong>Adres pocztowy</strong> - Still Fresh, Al. KEN 36 / 112B, WARSZAWA</p>
                </li>
                <li>
                    <p><strong>Adres poczty elektronicznej</strong> - Stillfresh@gmail.com</p>
                </li>
                <li>
                    <p><strong>Połączenie telefoniczne</strong> - +48 733 644 002</p>
                </li>
                <li>
